...
export class ApiService {
  ...
  register(uname:any,acno:any,pswd:any){
    ...
    //server call to register an account and retuen response to register component 
  ...
  login(acno:any,pswd:any){
    ...
    //server call to login  an account and retuen response to register component 
  ...
  appendToken(){
    ...
    //fetcch token from local storage
